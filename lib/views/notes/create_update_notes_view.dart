...
import 'package:myfitwizz/utilities/dialogs/cannot_share_empty_note_dialog.dart';
import 'package:myfitwizz/utilities/generics/get_arguments.dart';
import 'package:myfitwizz/services/cloud_crud/cloud_note.dart';
import 'package:myfitwizz/services/cloud_crud/firebase_cloud_storage.dart';
          ...
          IconButton(
            onPressed: () async {
              ...
              if (_note == null || text.isEmpty) {
                await showCannoShareEmptyNoteDialog(context);
              } else {
                Share.share(text);
              }
            },
